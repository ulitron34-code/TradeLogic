...
import { EMBEDDING_MODEL, extractTariffFractionMentions, fetchTesisDetail as defaultFetchTesisDetail, generateEmbedding as defaultGenerateEmbedding, searchTesis as defaultSearchTesis } from '@platform/jurisprudence';
