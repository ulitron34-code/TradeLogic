...
function usage() {
  return `Uso:\n  pnpm --filter @platform/db senasica:import -- --input corpus/senasica/regulatory-catalog.csv --source-version SENASICA-2025-12 --source-url https://www.datos.gob.mx/dataset/productos_regulados_registrados [--apply]\n\nSin --apply solo valida y reporta; nunca escribe en Supabase.\n`;
}
