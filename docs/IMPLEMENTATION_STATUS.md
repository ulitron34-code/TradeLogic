...
- Se agrego `scripts/smoke-production.cjs` y `npm run smoke:production` para validar `/health`, `/ready` y web despues de cada deploy, sin credenciales ni dependencias extra.
