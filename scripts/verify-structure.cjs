...
for (const marker of ['name: tradelogic-api', 'name: tradelogic-worker', 'healthCheckPath: /ready', 'startCommand: pnpm --filter @platform/api start', 'startCommand: pnpm --filter @platform/worker start']) {
